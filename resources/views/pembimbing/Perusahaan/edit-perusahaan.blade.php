...
<div class="card card-default">
    ...
    <div class="card-body">
      <!-- Create Perusahaan -->
      <form action="{{ route('pembimbing.perusahaan.update') }}" method="post">
        @csrf
        <input type="hidden" name="perusahaanID" value="{{ $Perusahaan->perusahaanID}}">
        <div class="row">
            <div class="col-md-6 mb-3">
                <label for="" class="form-label">Pendiri Perusahaan</label>
                <input type="text" class="form-control" name="pendiri" value="{{ $Perusahaan->pendiri}}">
            </div>
            <div class="col-md-6 mb-3">
                <label for="" class="form-label">Nama Perusahaan</label>
                <input type="text" class="form-control" name="nm_perusahaan" value="{{ $Perusahaan->nm_perusahaan}}">
            </div>
            <div class="col-md-6 mb-3">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="number" class="form-control" name="no_tlp" value="{{ $Perusahaan->no_tlp}}">
            </div>
            <div class="col-md-6 mb-3">
                <label for="" class="form-label">Tentang Perusahaan</label>
                <textarea class="form-control" name="deskripsi" id="deskripsi" rows="2">{{ $Perusahaan->deskripsi ?? '' }}</textarea>
        ...
        <button type="submit" class="btn btn-success mt-3">
            <i class="fas fa-pencil"></i> Ubah Data
        </button>
      </form>
    </div>
  </div>
