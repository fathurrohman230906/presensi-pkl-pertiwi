...
<!-- $isAdminAndSiswa = $isAdmin || $isSiswa;
$isAdminAndPembimbing = $isAdmin || $isPembimbing;
$isSiswaAndPembimbing = $isSiswa || $isPembimbing;
$isMultiUser = $isSiswaAndPembimbing || $isAdmin; -->
...
@endphp
    ...
    <div class="sidebar-left" data-simplebar style="height: 100%;">
      ...
      <ul class="nav sidebar-inner" id="sidebar-menu">
          ...
          <li class="{{ $DataPerusahaan ? 'active' : '' }} {{ $isSiswa ? 'd-none' : 'd-block' }}">
            <a class="sidenav-item-link" href="{{ $isAdminPembimbingWaliKelas ? $PerusahaanPage : '' }}">
