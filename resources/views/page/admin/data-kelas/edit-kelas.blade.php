    ...
    <div class="col-md-12 col-lg-12 col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('update.kelas.admin') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nm_kelas') is-invalid @enderror" id="nm_kelas" name="nm_kelas" placeholder="Masukkan Nama Kelas" value="{{ $kelas->nm_kelas }}">
                                @error('nm_kelas')
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('jurusanID') is-invalid @enderror" id="jurusan" name="jurusanID">
                            ...
                            @foreach($jurusan as $dataJurusan)
                                <option value="{{ $dataJurusan->jurusanID }}" @if($kelas->jurusanID == $dataJurusan->jurusanID) selected @endif>{{ $dataJurusan->nm_jurusan }}</option>
                            @endforeach
                        </select>
                        @error('jurusanID')
                            <div class="invalid-feedback">{{ $message }}</div>
